  ...
  <div>
    ...
    <div>
      ...
      >
        <a-row :gutter="24">
          <a-col :span="12">
            <UploadImgComponent :imgSize="imgSize" :imgName="'上传Banner图'" :imageUrl.sync="page.img" :actionUrl="actionUrl"></UploadImgComponent>
          </a-col>
        </a-row>
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-model-item ref="attribute1" label="关于我们" prop="attribute1">
              <a-input
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="内容">
              <vue-ueditor-wrap v-model="page.attribute2" :config="myConfig" editor-id="editor-demo-01"></vue-ueditor-wrap>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="24">
          <a-col :span="12">
            <UploadImgComponent :imgSize="imgSize2" :imgName="'企业文化图1'" :imageUrl.sync="page.attribute3" :actionUrl="actionUrl"></UploadImgComponent>
          </a-col>
          <a-col :span="12">
            <UploadImgComponent :imgSize="imgSize2" :imgName="'企业文化图2'" :imageUrl.sync="page.attribute5" :actionUrl="actionUrl"></UploadImgComponent>
          </a-col>
        </a-row>
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="企业文化1内容">
              <vue-ueditor-wrap v-model="page.attribute4" :config="myConfig" editor-id="editor-demo-02"></vue-ueditor-wrap>
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="企业文化1内容">
              <vue-ueditor-wrap v-model="page.attribute6" :config="myConfig" editor-id="editor-demo-03"></vue-ueditor-wrap>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="[24, 24]">
          <a-col :span="24">
            <ImgTextListComponent
              :list.sync="page.attribute7"
              :title="'企业风采'"
              :vActionName="'guide-page-about'"
              :imgSize="imgSize3"
              :imgName="imgName"
              :showImg="true"
              :showSummary="false"
        ...
        <a-row :gutter="24">
          <a-col :span="24">
            <a-button
              ...
              type="primary"
              @click="handleSave()"
              v-action:guide-page-about-edit
            >
              保存
            </a-button>
          </a-col>
...
export default {
  ...
  methods: {
    ...
    handleSave () {
      ...
      this.page.code = 'guide-page-about'
      this.$http
