<template>
  <div>
    ...
    <div class="tool-bar" style="margin-bottom: 16px">
      <a-row>
        <a-col :span="12">
          <div class="page-title">设计列表</div>
        </a-col>
        <a-col :span="12">
          <div class="btn-box">
            <a-button icon="rest" type="danger" @click="delSelect" :disabled="!hasSelected" v-action:design-del>批量删除</a-button>
            <a-button icon="plus" type="primary" @click="addItem()" v-action:design-add>添加</a-button>
    ...
    <div>
      ...
      >
        <div slot="sort" slot-scope="text">
          <div style="border-bottom: 1px solid #ddd; padding: 5px 0; text-indent: 12px;" v-if="!text.editable || !$store.getters.hasPermission('design-edit')" @click="showEdit(text)">{{ text.sort }}</div>
          <div v-else>
        ...
        <div slot="status" slot-scope="text">
          <a-switch
            ...
            :disabled="!$store.getters.hasPermission('design-edit')"
        ...
        <div class="action-box" slot="action" slot-scope="text">
          <a-tooltip placement="top" v-action:design-edit>
            <template slot="title">
              <span>修改</span>
            </template>
            <a-button type="primary" icon="edit" @click="editItem(text)"></a-button>
          </a-tooltip>
          <a-tooltip placement="top" v-action:design-del>
            <template slot="title">
              <span>删除</span>
            </template>
      ...
      <a-tabs defaultActiveKey="1">
        <a-tab-pane key="1" tab="基本信息">
          ...
          >
            ...
            <a-row :gutter="24">
              <a-col :span="12">
                <a-form-model-item ref="title" label="设计名称" prop="title">
                  <a-input
                    v-model="form.title"
                    @blur="
                      () => {
            ...
            <!-- <a-row :gutter="24">
              <a-col :span="12">
                <a-form-model-item ref="summary" label="简单描述" prop="summary">
                  <a-input
                    v-model="form.summary"
                    placeholder="例如：使用范围：卧室、厨房、小型店铺。"
                    @blur="
                      () => {
            ...
            <!-- <a-row :gutter="24">
              <a-col :span="12">
                <a-form-model-item ref="attribute2" label="产品说明" prop="attribute2">
                  <a-textarea
            ...
            <!-- <a-row :gutter="24">
              <a-col :span="12">
                <a-form-model-item ref="attribute3" label="结构特点" prop="attribute3">
                  <a-textarea
            ...
            <a-row :gutter="24">
              <a-col :span="12">
                <a-form-model-item ref="attribute4" label="应用范围" prop="attribute4">
                  <a-textarea
            ...
            <a-row :gutter="16">
              <a-col :span="6">
                <a-form-item label="设计封面图片" :extra="imgSize">
                  <a-upload
                    name="files[]"
        ...
        <a-tab-pane key="2" tab="轮播图">
          <div class="tool-bar" style="margin-bottom: 16px">
            <a-row>
              <a-col :span="24">
                <div class="btn-box">
                  <a-button icon="plus" type="primary" @click="addFunctionItem()" v-action:design-add>添加</a-button>
                </div>
              </a-col>
            </a-row>
          </div>
    ...
    >
      ...
      >
        ...
        <a-row :gutter="16">
          <a-col :span="24"><p style="color: red;">注意：添加或修改小图后，需要在上层点击提交按钮才会保存设计的修改。</p></a-col>
        </a-row>
      </a-form-model>
    </a-drawer>
  </div>
...
export default {
  ...
  methods: {
    ...
    showEdit (item) {
      if (this.$store.getters.hasPermission('design-edit')) {
        item.editable = true
        setTimeout(() => {
