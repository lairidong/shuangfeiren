  ...
  <div>
    ...
    <div>
      ...
      >
        <a-row :gutter="[24,24]">
          <a-col :span="24">
            <UploadImgComponent :imgSize="imgSize" :imgName="'专业的技术团队图片'" :imageUrl.sync="page.img" :actionUrl="actionUrl"></UploadImgComponent>
          </a-col>
          <a-col :span="12">
            <a-form-item label="专业的技术团队介绍">
              <a-textarea
        ...
        <a-row :gutter="[24, 24]">
          <a-col :span="24">
            <ImgTextListComponent
              ...
              :title="'专业的技术团队'"
              :vActionName="'product-development'"
              :imgSize="imgSize2"
              :imgName="imgName2"
              :showSummary="false"
              :showUrl="false"
        ...
        <a-row :gutter="[24,24]">
          <a-col :span="24">
            <a-button
              ...
              type="primary"
              @click="handleSave()"
              v-action:product-development-edit
            >
              保存
            </a-button>
          </a-col>
...
export default {
  ...
  methods: {
    ...
    handleSave () {
      ...
      this.page.code = 'product-development'
      this.$http
