    ...
    <div>
      ...
      >
        <a-tabs defaultActiveKey="1">
          <a-tab-pane key="1" tab="总部支持">
            <a-row :gutter="16">
              <a-col :span="6">
                <UploadImgComponent :imgSize="imgSize" :imgName="imgName" :imageUrl.sync="page.img"></UploadImgComponent>
              </a-col>
            </a-row>
            <a-row :gutter="24">
              <a-col :span="24">
                <a-form-model-item ref="content" label="总部支持内容" prop="content">
            ...
            <a-row :gutter="24">
              <a-col :span="24">
                <a-button icon="save" type="primary" @click="handleSave()" v-action:brand-support-edit>
                  保存
                </a-button>
              </a-col>
            </a-row>
          </a-tab-pane>
          <!-- <a-tab-pane key="2" tab="品牌支持">
            <a-row :gutter="16">
              <a-col :span="6">
                <UploadImgComponent :imgSize="imgSize2" :imgName="imgName2" :imageUrl.sync="page.attribute1"></UploadImgComponent>
              </a-col>
            </a-row>
            <a-row :gutter="16">
              <a-col :span="24">
                <a-form-model-item ref="attribute5" label="手机端图文" prop="attribute5">
                  <ImgTextListComponent
                    :list.sync="page.attribute5"
                    :title="'手机端图文'"
                    :vActionName="'brand-support'"
                    :imgSize="imgSize4"
                    :imgName="imgName4"
                    :showSummary="true"
                    :maxAdd="20"
          ...
          <a-tab-pane key="3" tab="技术支持">
            ...
            <a-row :gutter="24">
              <a-col :span="12">
                <UploadImgListComponent :imgSize="imgSize3" :imgName="'技术支持图'" :imageUrl.sync="page.attribute4" :actionUrl="actionUrl" :headers="headers"></UploadImgListComponent>
              </a-col>
            </a-row>
            <a-row :gutter="24">
              <a-col :span="24">
