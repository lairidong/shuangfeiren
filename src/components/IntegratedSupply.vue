  ...
  <div>
    ...
    <div>
      ...
      >
        <a-row :gutter="[24,24]">
          <a-col :span="24">
            <UploadImgComponent :imgSize="imgSize" :imgName="'整合零散需求，规模仓储集成供应'" :imageUrl.sync="page.img" :actionUrl="actionUrl"></UploadImgComponent>
          </a-col>
          <a-col :span="12">
            <a-form-item label="整合零散需求，规模仓储集成供应介绍">
              <a-textarea
        ...
        <a-row :gutter="[24, 24]">
          <a-col :span="24">
            <UploadImgListComponent :imgSize="imgSize3" :imgName="'图片集'" :imageUrl.sync="page.attribute1" :actionUrl="actionUrl" :headers="headers"></UploadImgListComponent>
          </a-col>
        </a-row>
        <a-row :gutter="[24,24]">
          <a-col :span="24">
            <a-button
              ...
              type="primary"
              @click="handleSave()"
              v-action:integrated-supply-edit
            >
              保存
            </a-button>
          </a-col>
...
export default {
  ...
  methods: {
    ...
    handleSave () {
      ...
      this.page.code = 'integrated-supply'
      this.$http
