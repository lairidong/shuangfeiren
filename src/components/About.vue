  ...
  <div>
    ...
    <div>
      ...
      >
        ...
        <a-row :gutter="16">
          <a-col :span="6">
            <UploadImgComponent :imgSize="imgSize" :imgName="'上传视频封面图'" :imageUrl.sync="page.img"></UploadImgComponent>
          </a-col>
        </a-row>
        <a-row :gutter="[24, 24]">
          <a-col :span="24">
            <UploadFileComponent :maxSize="100" :fileType="'mp4'" :imgName="'上传视频'" :fileUrl.sync="page.attribute1" :actionUrl="actionUrl2"></UploadFileComponent>
          </a-col>
        </a-row>
        <a-row :gutter="[24, 24]">
          <a-col :span="24">
            <a-button icon="save" type="primary" @click="handleSave()" v-action:about-edit>
              保存
            </a-button>
          </a-col>
        </a-row>
