    ...
    <div>
      ...
      >
        <a-tabs defaultActiveKey="1">
          <a-tab-pane key="1" tab="客户投诉流程">
            <a-row :gutter="24">
              <a-col :span="24">
                <a-form-model-item ref="content" label="客户投诉流程" prop="content">
            ...
            <a-row :gutter="24">
              <a-col :span="24">
                <a-button icon="save" type="primary" @click="handleSave()" v-action:service-edit>
                  保存
                </a-button>
              </a-col>
            </a-row>
          </a-tab-pane>
          <a-tab-pane key="3" tab="售后服务">
            <div class="tool-bar" style="margin-bottom: 16px">
              <a-row>
                <a-col :span="24">
                  <div class="btn-box">
                    <a-button icon="plus" type="primary" @click="addFunctionItem()" v-action:service-edit>添加</a-button>
                  </div>
                </a-col>
              </a-row>
            </div>
            ...
            >
              ...
              <div class="action-box" slot="action" slot-scope="text">
                <a-tooltip placement="top" v-action:service-edit>
                  <template slot="title">
                    <span>修改</span>
                  </template>
