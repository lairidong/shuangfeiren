  ...
  <div>
    ...
    <div class="tool-bar" style="margin-bottom: 16px">
      <a-row>
        ...
        <a-col :span="12">
          <div class="btn-box">
            <a-button icon="rest" type="danger" @click="delSelect" :disabled="!hasSelected" v-action:corporate-culture-del>批量删除</a-button>
            <a-button icon="plus" type="primary" @click="addItem()" v-action:corporate-culture-add>添加</a-button>
    ...
    <div>
      ...
      >
        <div slot="sort" slot-scope="text">
          <div style="border-bottom: 1px solid #ddd; padding: 5px 0; text-indent: 12px;" v-if="!text.editable || !$store.getters.hasPermission('corporate-culture-edit')" @click="showEdit(text)">{{ text.sort }}</div>
          <div v-else>
        ...
        <div slot="status" slot-scope="text">
          <a-switch
            ...
            :disabled="!$store.getters.hasPermission('corporate-culture-edit')"
        ...
        <div class="action-box" slot="action" slot-scope="text">
          <a-tooltip placement="top" v-action:corporate-culture-edit>
            <template slot="title">
              <span>修改</span>
            </template>
            <a-button type="primary" icon="edit" @click="editItem(text)"></a-button>
          </a-tooltip>
          <a-tooltip placement="top" v-action:corporate-culture-del>
            <template slot="title">
              <span>删除</span>
            </template>
    ...
    >
      ...
      >
        ...
        <a-row :gutter="24" v-if="showRichText">
          <a-col :span="24">
...
export default {
  ...
  watch: {
    $route: function () {
      ...
      this.form.parent_code = 'corporate-culture'
    }
  },
  created () {
    // this.getCate()
  ...
  methods: {
    ...
    showEdit (item) {
      if (this.$store.getters.hasPermission('corporate-culture-edit')) {
        item.editable = true
        setTimeout(() => {
