  ...
  <div>
    ...
    <div>
      ...
      >
        ...
        <a-row :gutter="24">
          <a-col :span="8">
            <a-form-model-item ref="attribute2" label="3个月会员" prop="attribute2">
              <a-input
                prefix="￥"
        ...
        <a-row :gutter="24">
          <a-col :span="8">
            <a-form-model-item ref="attribute3" label="6个月会员" prop="attribute3">
              <a-input
                prefix="￥"
        ...
        <a-row :gutter="24">
          <a-col :span="4">
            <a-form-model-item ref="attribute4" label="12个月会员" prop="attribute4">
              <a-input
                prefix="￥"
          ...
          <a-col :span="4">
            <a-form-model-item ref="attribute5" label="12个月会员(原价)" prop="attribute5">
              <a-input
                prefix="￥"
                suffix=" / 月"
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-model-item ref="attribute6" label="会员查询" prop="attribute6">
              <a-textarea
