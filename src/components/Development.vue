  ...
  <div>
    ...
    <div>
      ...
      >
        <a-row :gutter="[24,24]">
          <a-col :span="12">
            <UploadImgComponent :imgSize="imgSize" :imgName="'和谐共生,永续发展'" :imageUrl.sync="page.img" :actionUrl="actionUrl"></UploadImgComponent>
          </a-col>
          <a-col :span="12">
            <a-form-item label="内容">
              <vue-ueditor-wrap v-model="page.page_content" :config="myConfig" editor-id="editor-demo-01"></vue-ueditor-wrap>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="[24,24]">
          <a-col :span="12">
            <UploadImgComponent :imgSize="imgSize2" :imgName="'资源和能源'" :imageUrl.sync="page.attribute1" :actionUrl="actionUrl"></UploadImgComponent>
          </a-col>
          <a-col :span="12">
            <a-form-item label="内容">
              <vue-ueditor-wrap v-model="page.attribute2" :config="myConfig" editor-id="editor-demo-02"></vue-ueditor-wrap>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="[24,24]">
          <a-col :span="12">
            <UploadImgComponent :imgSize="imgSize2" :imgName="'材料选择'" :imageUrl.sync="page.attribute3" :actionUrl="actionUrl"></UploadImgComponent>
          </a-col>
          <a-col :span="12">
            <a-form-item label="内容">
              <vue-ueditor-wrap v-model="page.attribute4" :config="myConfig" editor-id="editor-demo-03"></vue-ueditor-wrap>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="[24,24]">
