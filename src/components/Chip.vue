    ...
    <a-tabs defaultActiveKey="1">
      <a-tab-pane key="1" tab="基本信息">
        ...
        >
          ...
          <a-row :gutter="24">
            <a-col :span="24">
              <a-form-model-item ref="attribute1" label="核心优势内容" prop="attribute1">
                <a-textarea
          ...
          <a-row :gutter="24">
            <a-col :span="24">
              <a-form-model-item ref="attribute2" label="商业案例内容" prop="attribute2">
                <a-textarea
      ...
      <a-tab-pane key="2" tab="核心优势">
        <div class="tool-bar" style="margin-bottom: 16px">
          <a-row>
            <a-col :span="24">
              <div class="btn-box">
                <a-button icon="plus" type="primary" @click="addAdvantageItem()" v-action:chip-edit>添加</a-button>
              </div>
            </a-col>
          </a-row>
        </div>
        ...
        >
          <div slot="sort" slot-scope="text">
            <div style="border-bottom: 1px solid #ddd; padding: 5px 0; text-indent: 12px;" v-if="!text.editable || !$store.getters.hasPermission('chip-edit')" @click="showEdit(text)">{{ text.sort }}</div>
            <div v-else>
          ...
          <div class="action-box" slot="action" slot-scope="text">
            <a-tooltip placement="top" v-action:chip-edit>
              <template slot="title">
                <span>修改</span>
              </template>
      ...
      <a-tab-pane key="3" tab="商业案例">
        <div class="tool-bar" style="margin-bottom: 16px">
          <a-row>
            <a-col :span="24">
              <div class="btn-box">
                <a-button icon="plus" type="primary" @click="addCaseItem()" v-action:chip-edit>添加</a-button>
              </div>
            </a-col>
          </a-row>
        </div>
