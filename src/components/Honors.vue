  ...
  <div>
    ...
    <div class="tool-bar" style="margin-bottom: 16px">
      <a-row>
        ...
        <a-col :span="12">
          <div class="btn-box">
            <a-button icon="rest" type="danger" @click="delSelect" :disabled="!hasSelected" v-action:honors-del>批量删除</a-button>
            <a-button icon="plus" type="primary" @click="addItem()" v-action:honors-add>添加</a-button>
    ...
    <div>
      ...
      >
        <div slot="sort" slot-scope="text">
          <div style="border-bottom: 1px solid #ddd; padding: 5px 0; text-indent: 12px;" v-if="!text.editable || !$store.getters.hasPermission('honors-edit')" @click="showEdit(text)">{{ text.sort }}</div>
          <div v-else>
        ...
        <div slot="status" slot-scope="text">
          <a-switch
            ...
            :disabled="!$store.getters.hasPermission('honors-edit')"
        ...
        <div class="action-box" slot="action" slot-scope="text">
          <a-tooltip placement="top" v-action:honors-edit>
            <template slot="title">
              <span>修改</span>
            </template>
            <a-button type="primary" icon="edit" @click="editItem(text)"></a-button>
          </a-tooltip>
          <a-tooltip placement="top" v-action:honors-del>
            <template slot="title">
              <span>删除</span>
            </template>
...
export default {
  ...
  methods: {
    ...
    showEdit (item) {
      if (this.$store.getters.hasPermission('honors-edit')) {
        item.editable = true
        setTimeout(() => {
