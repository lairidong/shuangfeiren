  ...
  <div>
    ...
    <div class="tool-bar" style="margin-bottom: 16px">
      <a-row>
        ...
        <a-col :span="12">
          <div class="btn-box">
            <a-button icon="rest" type="danger" @click="delSelect" :disabled="!hasSelected" v-action:team-del>批量删除</a-button>
            <a-button icon="plus" type="primary" @click="addItem()" v-action:team-add>添加</a-button>
      ...
      >
        <div slot="status" slot-scope="text">
          <a-switch
            ...
            :disabled="!$store.getters.hasPermission('team-edit')"
        ...
        <div class="action-box" slot="action" slot-scope="text">
          <a-tooltip placement="top" v-action:team-edit>
            <template slot="title">
              <span>修改</span>
            </template>
            <a-button type="primary" icon="edit" @click="editItem(text)"></a-button>
          </a-tooltip>
          <a-tooltip placement="top" v-action:team-del>
            <template slot="title">
              <span>删除</span>
            </template>
    ...
    >
      ...
      >
        ...
        <a-row :gutter="16">
          <a-col :span="24">
            <a-form-item label="上传封面图片" :extra="imgSize">
              <a-upload
                name="files[]"
