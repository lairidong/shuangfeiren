  ...
  <div>
    ...
    <div class="tool-bar" style="margin-bottom: 16px">
      <a-row>
        ...
        <a-col :span="12">
          <div class="btn-box">
            <a-button icon="rest" type="danger" @click="delSelect" :disabled="!hasSelected" v-action:services-del>
              批量删除
            </a-button>
            <a-button icon="plus" type="primary" @click="addItem()" v-action:services-add>
              添加
            </a-button>
      ...
      <a-table
        ...
        <div slot="is_home" slot-scope="text">
          <a-switch
            checkedChildren="是"
            unCheckedChildren="否"
            :disabled="!$store.getters.hasPermission('services-edit')"
        ...
        <div class="action-box" slot="action" slot-scope="text">
          <a-tooltip placement="top" v-action:services-edit>
            <template slot="title">
              <span>修改</span>
            </template>
            <a-button type="primary" icon="edit" @click="editItem(text)"></a-button>
          </a-tooltip>
          <a-tooltip placement="top" v-action:services-del>
            <template slot="title">
              <span>删除</span>
            </template>
      ...
      >
        <a-tabs default-active-key="1">
          <a-tab-pane key="1" tab="文章内容">
            ...
            <a-row :gutter="16">
              <a-col :span="24">
                <a-form-item label="上传Banner图片" :extra="imgSize">
                  <a-upload
                    name="files[]"
            ...
            <a-row :gutter="16">
              <a-col :span="24">
                <a-form-item label="上传封面图片" :extra="imgSize2">
                  <a-upload
                    name="files[]"
                    list-type="picture-card"
                    class="avatar-uploader"
            ...
            <a-row :gutter="16">
              <a-col :span="24">
                <a-form-item label="上传认证资质图片" :extra="imgSize3">
                  <a-upload
                    name="files[]"
                    list-type="picture-card"
                    class="avatar-uploader"
            ...
            <a-row :gutter="24">
              <a-col :span="12">
                <a-form-model-item ref="attribute1" label="领域分类" prop="attribute1">
                  <a-input
            ...
            <a-row :gutter="24">
              <a-col :span="12">
                <a-form-model-item ref="attribute2" label="检测价格" prop="attribute2">
                  <a-input
            ...
            <a-row :gutter="24">
              <a-col :span="12">
                <a-form-model-item ref="attribute3" label="检测周期" prop="attribute3">
                  <a-input
            ...
            <a-row :gutter="24">
              <a-col :span="12">
                <a-form-model-item ref="attribute4" label="检测类型" prop="attribute4">
                  <a-input
            ...
            <a-row :gutter="24">
              <a-col :span="12">
                <a-form-model-item ref="attribute5" label="送样方式" prop="attribute5">
                  <a-input
            ...
            <a-row :gutter="24">
              <a-col :span="12">
                <a-form-model-item ref="attribute6" label="服务地点" prop="attribute6">
                  <a-input
...
export default {
  data () {
    return {
      ...
      imgSize2: '',
      imgSize3: '',
      imgWidth: this.$route.query.img2.split(',')[0],
      searchItem: {
        cate_id: '',
        title: '',
        status: '',
  ...
  watch: {
    $route: function () {
      ...
      this.form.parent_code = 'services'
    }
  },
  created () {
    this.getCate()
