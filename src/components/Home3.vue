  ...
  <div>
    ...
    <div>
      ...
      >
        <a-row :gutter="24">
          <a-col :span="6">
            <a-form-model-item ref="attribute1" label="生活美容-消费返" prop="attribute1">
              <a-input
                suffix="%"
          ...
          <a-col :span="6">
            <a-form-model-item ref="attribute2" label="生活美容-会员用户返" prop="attribute2">
              <a-input
                suffix="%"
        ...
        <a-row :gutter="24">
          <a-col :span="6">
            <a-form-model-item ref="attribute3" label="成功分享好友，与好友同时享多返" prop="attribute3">
              <a-input
                suffix="%"
        ...
        <a-row :gutter="24">
          <a-col :span="6">
            <a-form-model-item ref="attribute4" label="医学美容-消费返" prop="attribute4">
              <a-input
                suffix="%"
          ...
          <a-col :span="6">
            <a-form-model-item ref="attribute5" label="医学美容-会员用户返" prop="attribute5">
              <a-input
                suffix="%"
