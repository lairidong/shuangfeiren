  ...
  <div>
    ...
    <div>
      ...
      >
        <a-row :gutter="[24,24]">
          <a-col :span="24">
            <UploadImgComponent :imgSize="imgSize" :imgName="'共同发展 共同进步图片'" :imageUrl.sync="page.img" :actionUrl="actionUrl"></UploadImgComponent>
          </a-col>
          <a-col :span="12">
            <a-form-item label="共同发展 共同进步介绍">
              <a-textarea
