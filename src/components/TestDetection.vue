  ...
  <div>
    ...
    <div>
      ...
      >
        <a-row :gutter="[24,24]">
          <a-col :span="24">
            <UploadImgComponent :imgSize="imgSize" :imgName="'科学检测'" :imageUrl.sync="page.img" :actionUrl="actionUrl"></UploadImgComponent>
          </a-col>
          <a-col :span="12">
            <a-form-item label="科学检测介绍">
              <a-textarea
        ...
        <a-row :gutter="[24,24]">
          <a-col :span="24">
            <UploadImgComponent :imgSize="imgSize" :imgName="'门窗检测'" :imageUrl.sync="page.attribute1" :actionUrl="actionUrl"></UploadImgComponent>
          </a-col>
        </a-row>
        <a-row :gutter="[24, 24]">
          <a-col :span="24">
            <ImgTextListComponent
              :list.sync="page.attribute2"
              :title="'门窗检测'"
              :vActionName="'test-detection'"
              :imgSize="imgSize2"
              :imgName="imgName2"
              :showImg="false"
              :showSummary="false"
        ...
        <a-row :gutter="[24,24]">
          <a-col :span="24">
            <UploadImgComponent :imgSize="imgSize" :imgName="'构件检测'" :imageUrl.sync="page.attribute3" :actionUrl="actionUrl"></UploadImgComponent>
          </a-col>
        </a-row>
        <a-row :gutter="[24, 24]">
          <a-col :span="24">
