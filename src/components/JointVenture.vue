    ...
    <div>
      ...
      >
        <a-tabs defaultActiveKey="1">
          <a-tab-pane key="1" tab="门店">
            <a-row :gutter="16">
              <a-col :span="24">
                <ImgTextListComponent
                  :list.sync="page.attribute1"
                  :title="'门店'"
                  :vActionName="'joint-venture'"
                  :imgSize="imgSize"
                  :imgName="imgName"
                  :showSummary="true"
                  :maxAdd="20"
            ...
            <a-row :gutter="24">
              <a-col :span="24">
                <a-button icon="save" type="primary" @click="handleSave()" v-action:joint-venture-edit>
                  保存
                </a-button>
              </a-col>
            </a-row>
          </a-tab-pane>
          <a-tab-pane key="2" tab="项目收益">
            <a-row :gutter="16">
              <a-col :span="12">
            ...
            <a-row :gutter="16">
              <a-col :span="6">
                <UploadImgComponent :imgSize="imgSize2" :imgName="imgName2" :imageUrl.sync="page.attribute3"></UploadImgComponent>
              </a-col>
            </a-row>
            <a-row :gutter="24">
              <a-col :span="24">
